...
flagship: false
tone: d3
kicker: AI-powered expense management
...
seoDescription: >-
  ...
  tracking. Active in South Africa and Canada, with accounting-firm reseller
  partnerships.
showMetrics: false
...
capabilities:
  ...
  - name: Real-time tracking
    detail: >-
      Employees see where their claim stands; finance sees spend as it happens
      rather than at month-end.
traction:
  heading: Active in two markets
  items:
    ...
    - client: Reseller partnerships
      detail: >-
        ...
        their client base on successful trial completion.
---
...
ExpenseFlow removes the capture step entirely. A photograph is enough: the
merchant, amount, date, tax component and category are read from the receipt
itself. What used to be a form becomes a confirmation.
...
That design is why ExpenseFlow could move into a second market without being
rewritten, and why two Canadian accounting firms are prepared to put it in
front of their own client bases.
